...
class Love extends Controller {
	...
	public function index() {
		...
		$this->email->message('Hello Sanita, you just confirmed your appointment with Paolo.<br/><br/>' . $this->input->post('message') . '<br/>Have fun!! <br/><br/>Sincerely,<br/>The MagicClick Team');
